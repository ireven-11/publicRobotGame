...
NormalBulletStatus::NormalBulletStatus(const float attackPower)
...
NormalBulletStatus::~NormalBulletStatus()
{
}


void NormalBulletStatus::init()
{
	isUsing_				= false;
...
void NormalBulletStatus::use(const VECTOR initPosition, const float initSpeed, const VECTOR initDirection)
{
	isUsing_		= true;
...
void NormalBulletStatus::setPosition()
{
...
void NormalBulletStatus::deathpown()
{
	//時間経過でデスポーン
